...
interface DiaryCommentControllerDocs {
    @PostMapping
    ...
    @ApiResponses(
        ApiResponse(
            ...
            content = [Content(schema = Schema(implementation = DiaryCommentCreateRes::class))]
        ),
    ...
    @ApiResponses(
        ApiResponse(
            ...
            content = [Content(schema = Schema(implementation = DiaryCommentUpdateRes::class))]
        ),
        ApiResponse(responseCode = "400", description = "잘못된 요청"),
        ApiResponse(responseCode = "401", description = "인증 실패"),
