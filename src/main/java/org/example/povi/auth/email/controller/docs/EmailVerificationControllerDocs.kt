...
interface EmailVerificationControllerDocs {
    ...
    @Operation(
        ...
        description = "토큰을 이용해 이메일 인증 여부를 검증합니다."
    )
    @ApiResponses(
        value = [
    ...
    @Operation(
        ...
        description = "이메일 주소의 인증 완료 여부를 조회합니다."
    )
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200",
                description = "이메일 인증 상태 조회 성공",
